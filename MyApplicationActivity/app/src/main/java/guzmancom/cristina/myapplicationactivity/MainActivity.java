  ...
  public static final int LOGIN_INTENT_CODE=20;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode==LOGIN_INTENT_CODE){
            ...
            Toast.makeText(this,nombreUsuario+""+password,Toast.LENGTH_SHORT).show();
            //PROGRAMAR LO QUE SE DEBE REALIZAR CUANDO INTRODUSCA USUARIO Y CONTRASEÑA
        }
    }
}
